  ...
  grunt.initConfig({
    ...
    compass: {
      options: {
        ...
        raw: 'extensions_dir = "<%= config.app %>/bower_components"\n',
		    importPath: ['<%= config.app %>/bower_components/bootstrap/scss'],
        bundleExec: true
      },
      dist: {
        options: {
      ...
      dist: {
        options: {
          archive: function() {
            ...
            return 'package/Sir Pastes A-lot-' + manifest.version + '.zip';
          }
        },
        files: [{
          expand: true,
